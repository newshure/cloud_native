...
# MEMORY_CONF
export JAVA_G1_HEAP_REGION_SIZE=${JAVA_G1_HEAP_REGION_SIZE:-16M}
...
export QUERY_TOTAL_MEMORY=${QUERY_TOTAL_MEMORY:-40GB}
export QUERY_MAX_MEMORY=${QUERY_MAX_MEMORY:-20GB}
...
exec ${TRINO_HOME}/bin/launcher run \
  --etc-dir           ${TRINO_CONF_DIR} \
  --launcher-log-file ${TRINO_LAUNCHER_LOG} \
  --server-log-file   ${TRINO_SERVER_LOG}
